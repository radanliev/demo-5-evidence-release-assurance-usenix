...
| **Merkle build, $N=10^6$** | **1,858.07 ms** (mean of 5, Apple M4 Max, domain-separated tree) | `results/benchmark_summary.json` (regenerated by `scripts/run_release_benchmark.py`; the paper's macros track this file) |
| **Peak verifier throughput** | **6,810 ± 487 ops/s at 4 workers** (three-trace bundles) | `results/benchmark_summary.json` |
